...
var accessibilityIconStr = (accessibilitySign === "classic") ? 'https://link.csail.mit.edu/projects/devel/2016/ama/accessibility-menu/accessibility.png' : 'https://link.csail.mit.edu/projects/devel/2016/ama/accessibility-menu/access.png';
...
function prepMenu() {
    ...
    switch (lang) {
        case "he_IL":
            ...
            break;
        case "en_US":
            menuHTML = "<button class='transparentButton' onclick='toggleAccessibilityMenu()'><img class='accessibilityimage' src='https://link.csail.mit.edu/projects/devel/2016/ama/accessibility-menu/accessibility.png' alt='Accessibility Menu Icon' role='navigation' title='Accessibility Menu'/></button>";
            menuHTML += "<div id='slideout_inner'>";
            ...
            break;
        case "es_ES":
            menuHTML = "<button class='transparentButton' onclick='toggleAccessibilityMenu()'><img class='accessibilityimage' src='https://link.csail.mit.edu/projects/devel/2016/ama/accessibility-menu/accessibility.png' alt='Icono del menú Accesibilidad' role='navigation' title='Menú accesibilidad'/></button>";
            menuHTML += "<div id='slideout_inner'>";
            menuHTML += "<ul class='ltr'>";
            ...
            break;
        case "pt_PT":
            menuHTML = "<button class='transparentButton' onclick='toggleAccessibilityMenu()'><img class='accessibilityimage' src='https://link.csail.mit.edu/projects/devel/2016/ama/accessibility-menu/accessibility.png' alt='ícone do menu de acessibilidade' role='navigation' title='menu de acessibilidade'/></button>";
            menuHTML += "<div id='slideout_inner'>";
            menuHTML += "<ul class='ltr'>";
            menuHTML += "<button class='accessibilityMenuButton alignLeft' id='btnTextSizeOn' onclick='setTextSize(true);'><i class='fa fa-text-height' aria-hidden='true'></i>&nbsp;&nbsp;letra grande</button>";
            ...
            break;
        case "ja_JP":
            menuHTML = "<button class='transparentButton' onclick='toggleAccessibilityMenu()'><img class='accessibilityimage' src='https://link.csail.mit.edu/projects/devel/2016/ama/accessibility-menu/accessibility.png' alt='アクセシビリティメニューアイコン' role='navigation' title='アクセシビリティメニュー'/></button>";
            menuHTML += "<div id='slideout_inner'>";
            menuHTML += "<ul class='ltr'>";
            ...
            break;
        case "it_IT":
            menuHTML = "<button class='transparentButton' onclick='toggleAccessibilityMenu()'><img class='accessibilityimage' src='https://link.csail.mit.edu/projects/devel/2016/ama/accessibility-menu/accessibility.png' alt='Icona Accessibilità Menu' role='navigation' title='Accessibilità Menu'/></button>";
            menuHTML += "<div id='slideout_inner'>";
            menuHTML += "<ul class='ltr'>";
            ...
            break;
        case "fr_FR":
            menuHTML = "<button class='transparentButton' onclick='toggleAccessibilityMenu()'><img class='accessibilityimage' src='https://link.csail.mit.edu/projects/devel/2016/ama/accessibility-menu/accessibility.png' alt='Accessibilité Menu icon' role='navigation' title='Accessibilité Menu'/></button>";
            menuHTML += "<div id='slideout_inner'>";
            menuHTML += "<ul class='ltr'>";
            ...
            break;
        case "de_DE":
            menuHTML = "<button class='transparentButton' onclick='toggleAccessibilityMenu()'><img class='accessibilityimage' src='https://link.csail.mit.edu/projects/devel/2016/ama/accessibility-menu/accessibility.png' alt='Barrierefreiheit Menü Icon' role='navigation' title='Erreichbar Menü'/></button>";
            menuHTML += "<div id='slideout_inner'>";
            menuHTML += "<ul class='ltr'>";
            ...
            break;
        case "zh_CN":
            menuHTML = "<button class='transparentButton' onclick='toggleAccessibilityMenu()'><img class='accessibilityimage' src='https://link.csail.mit.edu/projects/devel/2016/ama/accessibility-menu/accessibility.png' alt='辅助功能菜单图标' role='navigation' title='辅助菜单'/></button>";
            menuHTML += "<div id='slideout_inner'>";
            menuHTML += "<ul class='ltr'>";
    ...
    var cssText = "<link href='https://link.csail.mit.edu/projects/devel/2016/ama/accessibility-menu/yellow-links.css' title='yellow' type='text/css' rel='stylesheet' disabled='true'/>";
    cssText += "<link href='https://link.csail.mit.edu/projects/devel/2016/ama/accessibility-menu/underline-links.css' title='underline' type='text/css' rel='stylesheet' disabled='true'/>";
    cssText += "<link href='https://link.csail.mit.edu/projects/devel/2016/ama/accessibility-menu/grayscale.css' title='grayscale' type='text/css' rel='stylesheet' disabled='true'/>";

    if (sourceMenu == "accessible+") {
        cssText += "<link href='https://link.csail.mit.edu/projects/devel/2016/ama/accessibility-menu/night.css' title='contrast' type='text/css' rel='stylesheet' disabled='true'/>";
        cssText += "<link href='https://link.csail.mit.edu/projects/devel/2016/ama/accessibility-menu/biggest.css' title='textsize' type='text/css' rel='stylesheet' disabled='true'/>";
    } else {
        cssText += "<link href='https://link.csail.mit.edu/projects/devel/2016/ama/accessibility-menu/high-contrast.css' title='contrast' type='text/css' rel='stylesheet' disabled='true'/>";
        cssText += "<link href='https://link.csail.mit.edu/projects/devel/2016/ama/accessibility-menu/bigger.css' title='textsize' type='text/css' rel='stylesheet' disabled='true'/>";
    }
    ...
    if (newSize === "true" || newSize === true) {
        ...
        if ($('link[title=textsize]').length == 0) {
            $("<link/>", {
                rel: "stylesheet",
                type: "text/css",
                href: "https://link.csail.mit.edu/projects/devel/2016/ama/accessibility-menu/bigger.css",
                title: "textsize"
            }).appendTo("head");
    ...
    if (!(mode === "true" || mode === true)) {
        ...
        if ($('link[title=underline]').length == 0) {
            ...
            $("<link/>", {
                rel: "stylesheet",
                type: "text/css",
                href: "https://link.csail.mit.edu/projects/devel/2016/ama/accessibility-menu/underline-links.css",
                title: "underline"
            }).appendTo("head");
        } else {
    ...
    if (!(mode === "true" || mode === true)) {
        ...
        if ($('link[title=yellow]').length == 0) {
            $("<link/>", {
                rel: "stylesheet",
                type: "text/css",
                href: "https://link.csail.mit.edu/projects/devel/2016/ama/accessibility-menu/yellow-links.css",
                title: "yellow"
            }).appendTo("head");
        } else {
    ...
    if (!(mode === "true" || mode === true)) {
        ...
        if ($('link[title=contrast]').length == 0) {
            $("<link/>", {
                rel: "stylesheet",
                type: "text/css",
                href: "https://link.csail.mit.edu/projects/devel/2016/ama/accessibility-menu/high-contrast.css",
                title: "contrast"
            }).appendTo("head");
     ...
     if (!(mode === "true" || mode === true)) {
        ...
        if ($('link[title=contrast]').length == 0) {
            $("<link/>", {
                rel: "stylesheet",
                type: "text/css",
                href: "https://link.csail.mit.edu/projects/devel/2016/ama/accessibility-menu/grayscale.css",
                title: "grayscale"
            }).appendTo("head");
